...
import com.longhorn.smartlib.util.CRC8;
...
public class DataCode implements ICodeData {
    ...
    // the crc here means the crc of the data and sequence header be transformed it is calculated by index and data to be transformed
